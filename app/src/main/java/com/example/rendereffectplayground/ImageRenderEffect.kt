package com.example.rendereffectplayground
...
import com.example.rendereffectplayground.components.BlurContainer
import com.example.rendereffectplayground.components.ShaderContainer
...
fun ImageRenderEffect() {
    ...
    Column(
        ...
        ShaderContainer(
            ...
            BlurContainer(modifier = Modifier.fillMaxSize(),
                blur = blur.value,
                component = {
                    AnimatedContent(
                        targetState = image,
